class data():
    def __init__(self, folder="./data/"):
        ...
        self.dev_eval_exp2 = self.train_folder + "dev-eval-exp2.json"
        self.deb_eval_exp3 = self.train_folder + "dev-eval-exp3.json"
        ...
        self.dev_emb_file = self.embed_folder + "deb_emb.json"
