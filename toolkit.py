...
def squad_data_import(data_path="./data", train_link="https://rajpurkar.github.io/SQuAD-explorer/dataset/train-v2.0.json",
    dev_link="https://rajpurkar.github.io/SQuAD-explorer/dataset/dev-v2.0.json",
    test_link="https://rajpurkar.github.io/SQuAD-explorer/dataset/train-v2.0.json"):
    """
    author: Rohit Musti
    
    This function downloads the v2 data for the squad dataset
    """
    http = urllib3.PoolManager()
    train = http.request('GET', train_link)
    print(train.status)
#    urllib3.request.urlretrieve(train_link, data_path)
#    urllib3.request.urlretrieve(dev_link, data_path)
#    urllib3.request.urlretrieve(test_link, data_path)

def standardize(item):
    """
    author: Rohit Musti

    this is just a basic function to replace all double single quotes with double quotes and all back tiks with double quotee
    """
    return item.replace("''", '" ').replace("``", '" ')

def word_tokenize(sent):
    """
    src: https://github.com/HKUST-KnowComp/R-Net/
    """
    nlp = spacy.blank('en')
    doc = nlp(sent)
...
def prepro(config):
    """
    src: https://github.com/HKUST-KnowComp /R-Net/
    TODO: Parse the config file and set it up for my particular needs
    """
